...
public class AlgorithmRunConfiguration implements Serializable{
	...
	public String getExperiementKey() {
		return experiementKey;
	}

	public void setExperiementKey(String experiementKey) {
		this.experiementKey = experiementKey;
	}
}
